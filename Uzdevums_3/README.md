...
Sagatavo amata aprakstu pozīcijai:
"Datu ievades operators"

Konteksts:
– Darbs notiek izglītības iestādē
– Ikdienas darbs saistīts ar datu ievadi informācijas sistēmās
– Nav nepieciešamas programmēšanas zināšanas
– Svarīga precizitāte, konfidencialitāte un uzmanība detaļām

Prasības:
– Latviešu valodā
– Formāls, bet saprotams tonis
– Garums: aptuveni 1 A4 lapa
– Strukturēts ar virsrakstiem un punktiem
...
Neraksti algu vai konkrētu iestādes nosaukumu.
````

👉 Rezultātā tiks izveidots **pilnvērtīgs amata apraksta melnraksts**.

---

## ✏️ 2. solis – Darbs Canvas režīmā

Atver ģenerēto tekstu **Canvas režīmā** un turpini darbu ar dokumentu.
...
### 2.2. Korekcijas ar MI palīdzību (MI → redaktors)
...
👉 Šeit MI darbojas kā **redaktors**, nevis rakstītājs.
...
* Jo labāks konteksts → jo labāks rezultāts
